...
─────
    ...
    from policylab.v2.policy.parser import california_sb53
...
if TYPE_CHECKING:
    from policylab.v2.policy.parser import PolicySpec
    from policylab.v2.simulation.hybrid_loop import HybridSimResult
...
def generate_evidence_pack(
    ...
    Parameters
    ──────────
    ingest_result : IngestResult from policylab.v2.ingest.pipeline, or None.
