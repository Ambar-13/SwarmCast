...
def cmd_blind_spots(args):
    ...
    from swarmcast.features.blind_spot_finder import BlindSpotFinder
    from swarmcast.features.war_game import (
        FRAMEWORK_MINIMAL, FRAMEWORK_MODERATE, FRAMEWORK_STRICT,
    )
...
def cmd_backtest(args):
    ...
    from swarmcast.features.stress_tester import StressTester
    from swarmcast.validation.backtester import (
...
def cmd_v2_stress_test(args):
    ...
    """
    from swarmcast.v2.stress_test_v2 import HybridStressTest, HybridEnsembleReport
    ...
    if use_llm:
        ...
        try:
            ...
            try:
                from swarmcast.embedder import EmbedderModel
                llm_embedder = EmbedderModel()
            except Exception:
                from swarmcast.v2.simulation.llm_bridge import RandomEmbedder
    ...
    if use_llm:
        ...
        def run_with_llm(policy_name, policy_description, policy_severity=None, n_ensemble=5):
            ...
            from swarmcast.v2.stress_test_v2 import HybridEnsembleReport
...
def cmd_demo(args):
    ...
    from swarmcast.scenarios.simple_regulation import (
    ...
    print("=" * 70)
    from swarmcast.validation.backtester import Backtester, EU_AI_ACT
