...
from swarmcast.disclaimers import indicator_disclaimer, backtest_disclaimer
...
from swarmcast.validation.contamination_guard import detect_contamination
...
class Backtester:
    ...
    def backtest(
        ...
        if self.embedder is not None:
            from swarmcast.validation.semantic_matcher import SemanticMatcher
    ...
    def backtest_all(self) -> list[BacktestReport]:
        ...
        from swarmcast.validation.contamination_guard import get_fictional_cases
