...
from swarmcast.v2.population.agents import (
    PopulationAgent,
    generate_population,
    summarize_population,
)
from swarmcast.v2.network.social_graph import (
    build_governance_network,
    get_neighbor_beliefs,
    compute_network_statistics,
    identify_hubs,
)
from swarmcast.v2.stocks.governance_stocks import (
    GovernanceStocks,
    CompanyStock,
    BurdenStock,
    InnovationCapacity,
...
from swarmcast.v2.simulation.events import EventQueue
...
def run_hybrid_simulation(
    ...
    if config.run_llm_strategic:
        ...
        try:
            from swarmcast.v2.simulation.llm_bridge import (
    ...
    for round_num in range(1, config.num_rounds + 1):
        ...
        if llm_agents and llm_world_state is not None:
            ...
            try:
                from swarmcast.v2.simulation.llm_bridge import run_llm_round
        ...
        if (
            ...
            try:
                from swarmcast.v2.influence.adversarial import inject_beliefs
