...
Usage
─────
    from swarmcast.v2.influence.adversarial import AdversarialInjector, run_with_injection
...
def run_with_injection(
    ...
    from swarmcast.v2.population.vectorized import build_influence_matrix, PopulationArray
