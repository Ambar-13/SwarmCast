...
class ComparisonPolicy:
    ...
    Distinct from swarmcast.v2.policy.parser.PolicySpec (which has 10+ fields
...
def compare_policies(
    ...
    for pol in policies:
        ...
        sev = pol.severity
        if sev is None:
            from swarmcast.v2.stress_test_v2 import _detect_severity
    ...
    for val in values:
        ...
        for i in range(n_ensemble):
            ...
            if parameter == "ongoing_burden_rate":
                import swarmcast.v2.simulation.hybrid_loop as hl_mod
